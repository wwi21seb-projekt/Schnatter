<script lang="ts">
	...
	const loggedIn = 'flex justify-start md:justify-center flex-col mb-[70px]';
	const notLoggedIn = 'flex md:flex-row-reverse justify-start md:justify-center flex-col mb-[70px]';
