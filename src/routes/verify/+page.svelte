...
<main class="flex justify-center items-center w-screen h-screen">
	<div class="card w-[40vw] h-[50vh] p-5">
		...
		<div class="w-full h-full flex flex-col items-center justify-around">
            <p>Please verify your account. You have received an email to the specified email address! Please enter the code it contains here:</p>
			<input
            ...
            <div class="flex flex-row items-center justify-around w-2/5 ">
                ...
                <button on:click={handleSubmit} disabled={!formCorrectCode} class="btn variant-filled-primary" >Verify</button>
            </div>
		</div>
