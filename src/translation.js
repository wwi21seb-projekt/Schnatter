export default {
	en: {
		...
		'login.subtitle.forgotPwd': 'Forgot your Password?',
		'login.subtitle.resetPwd': 'Click here',
		...
		'register.button.addPicture': 'Add profile picture',
		'post.postComment.placeholder': 'Leave a comment!',
		'post.comments.header': 'Comments',
		'post.comments.buttonShowComment': 'Comment',
		'post.comments.buttonShowComments': 'Comments',
		...
		'post.repost.deleted': 'The post was deleted',
		...
		'modalCreatePost.pictures.fileTypes': 'Allowed .png, .jpg, .webp, .svg',
		'modalCreatePost.pictures.altText': 'Your upload',
		...
		'modalChangePassword.changeButton': 'Reset',
		'modalForgotPassword.header': 'Reset Password',
		'modalForgotPassword.username': 'username',
		'modal.forgotPwd.resendToken': 'Resend Code',
		'modalForgotPassword.token': 'code',
		'modal.forgotPwd.sendToken': 'Send Code',
		'modalChangePassword.pwdReset': 'Reset Password',
		'modalDeletePost.confirm': 'Do you really want to delete the post?',
		'modal.profilePicture.upload': 'Upload profile picture',
		'modal.profilePicture.uploadother': 'Upload another picture',
		'modal.profilePicture.cut': 'Crop',
		'modal.profilePicture.hint':
			'Make sure your content is centred in the section, as the image is displayed round in most places!',
		'modal.profilePicture.select': 'Select',
		'profile.posts': 'Posts',
		...
		'toast.notifications.message': 'You have a new message from',
		'toast.notifications.follow': 'followed you',
		'toast.notifications.repost': 'have reposted a post from you',
		'toast.notifications.default': 'You have a new notification',
	...
	de: {
		...
		'login.subtitle.forgotPwd': 'Passwort vergessen?',
		'login.subtitle.resetPwd': 'Klicke hier',
		...
		'register.button.addPicture': 'Profilbild hinzufügen',
		'post.postComment.placeholder': 'Schreib einen Kommentar!',
		'post.comments.header': 'Kommentare',
		'post.comments.buttonShowComment': 'Kommentar',
		...
		'post.repost.deleted': 'Der Beitrag wurde gelöscht',
		'modalCreatePost.header.Text': 'Text',
		...
		'modalCreatePost.pictures.fileTypes': 'Erlaubt sind .png, .jpg, .webp, .svg',
		'modalCreatePost.pictures.altText': 'Dein Upload',
		...
		'modalChangePassword.changeButton': 'Zurücksetzen',
		...
		'modal.forgotPwd.resendToken': 'Code erneut versenden',
		'modalDeletePost.confirm': 'Möchtest du den Post wirklich löschen?',
		'modal.profilePicture.upload': 'Profilbild hochladen',
		'modal.profilePicture.uploadother': 'Anders Bild hochladen',
		'modal.profilePicture.cut': 'Zuschneiden',
		'modal.profilePicture.hint':
			'Achte darauf deinen Content mittig im Ausschnitt zu setzen, da das Bild an den meisten Stellen rund angezeigt wird!',
		'modal.profilePicture.select': 'Verwenden',
		...
		'toast.userNotFound': 'Nutzer nicht gefunden!',
		'toast.tokenSent': 'Code wurde versendet.',
		'toast.pwdReset': 'Passwort wurde ersetzt.',
		'toast.pwdNotReset': 'Passwort konnte nicht geändert werden!',
		'toast.tokenInvalid': 'Ungültiger Code!',
		'toast.notifications.message': 'You have a new message from',
		'toast.notifications.follow': 'followed you',
		'toast.notifications.repost': 'have reposted a post from you',
		'toast.notifications.default': 'Du hast eine neue Benachrichtigung',
		...
		'settings.server': 'Server wechseln',
